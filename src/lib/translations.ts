...
export const TR: Record<Lang, Translation> = {
  en: {
    ...
    probHeading: "Running a service center on paper in 2025?",
    ...
    footCopy: "© 2025 Lumora Ventures PVT Ltd.\nKandy, Sri Lanka.",
    footProduct: "Product",
    footSupport: "Support",
    footLegal: "Legal",
    footPrivacy: "Privacy Policy",
    footTerms: "Terms of Service",
    footBuilt: "Built in Kandy, Sri Lanka 🇱🇰 · Service Intelligence",
  },
  si: {
    navFeatures: "ලක්ෂණ",
    ...
    heroEyebrow: "දැන් ශ්‍රී ලංකාවේ ලබාගත හැකිය",
    heroH1a: "ඔබේ සේවා මධ්‍යස්ථානය.",
    heroH1b: "ස්මාර්ට් ලෙස ක්‍රියාත්මකයි.",
    heroSub:
      "PitstopIQ කඩදාසි සේවා කාඩ්පත් ඩිජිටල් වේදිකාවකින් ප්‍රතිස්ථාපනය කරයි. එය සෑම වාහනයකම ලුහු බඳියි, ස්වයංක්‍රීය SMS මතක් කිරීම් යවයි, ඔබේ ව්‍යාපාරය සම්පූර්ණයෙන් දෘශ්‍යමාන කරයි.",
    heroCta1: "WhatsApp හරහා ආරම්භ කරන්න",
    heroCta2: "මිල බලන්න",
    heroStat1: "LKR 4,999 / මාසයකට",
    heroStat2: "සැකසීමේ ගාස්තු නොමැත · ඕනෑ වේලාවක අවලංගු කරන්න",
    probLabel: "ගැටළුව",
    probHeading: "2025 දී කඩදාසි මත සේවා මධ්‍යස්ථානයක් පවත්වාගෙන යනවාද?",
    ...
    probC3t: "ව්‍යාපාර දෘශ්‍යතා නැත",
    probC3d:
      "කුමන සේවාව වැඩිම ආදායම් දෙනවාද? කුමන තාක්ෂණිකයා ලාභදායිද? ස්ථාවර කොටස් කොපමණ ද? ඒ සියල්ල කඩදාසිවල සිරවී ඇත.",
    ...
    feat1d:
      "සෑම වාහනයක්ම සම්පූර්ණ තොරතුරු සමඟ ලියාපදිංචි කරන්න. සෑම සේවාවක්ම සටහන් වේ. QR scan ලෙස ඉතිහාසය ලබාගත හැකිය.",
    ...
    feat4d:
      "ඔබේ තෙල්, ෆිල්ටර් සහ අමතර කොටස් හඹා යන්න. අඩු ගබඩා සීමා සකසන්න. සේවාවකදී භාවිත කෙරෙන ස්ථාවර කොටස් ස්වයංක්‍රීයව අඩු වේ.",
    feat5t: "ඉන්වොයිස් නිර්මාණය",
    feat5d:
      "සේවා ජොබ් කාඩ්පතෙන් නේරදිවිය PDF ඉන්වොයිස් සාදන්න. ගනුදෙනුකරුගේ WhatsApp එකට tap එකකින් යවන්න.",
    ...
    hiw2d:
      "පවතින ගනුදෙනුකරුවන් සහ ඔවුන්ගේ වාහන ඇතුළු කරන්න. වාහනයකට මිනිත්තු 2 ක් ඇති. ඔබේ technician drop-off ේදී කළ හැකිය.",
    hiw3l: "පියවර 03",
    hiw3t: "PitstopIQ ස්වයංක්‍රීයව ක්‍රියාත්මකයි",
    hiw3d:
      "සෑම සේවාවකටම SMS ස්වයංක්‍රීයව යයි. සෑම රාත්‍රිම due වාහන සඳහා SMS යයි. ඔබ වැඩට අවධානය යොමු කරන්න.",
    priceLabel: "මිල ගණන්",
    ...
    footBuilt: "මහනුවර, ශ්‍රී ලංකාව 🇱🇰 · සේවා බුද්ධිය",
  },
  ta: {
    ...
    probLabel: "சிக்கல்",
    probHeading: "2025 இல் காகிதத்தில் சேவை மையம் நடத்துகிறீர்களா?",
    probC1t: "தொலைந்த சேவை அட்டைகள்",
    probC1d:
      "வாடிக்கையாளர்கள் எண்ணெய் தர அட்டையை தொலைக்கிறார்கள். பதிவில்லை, நினைவூட்டல் இல்லை, திரும்பி வர மாட்டார்கள்.",
    probC2t: "தானியங்கி நினைவூட்டல்கள் இல்லை",
    probC2d:
      "வாடிக்கையாளரை நினைவூட்ட ஒரே வழி கையால் போன் செய்வது — பிஸியான நாளில் இது நடக்காது.",
    probC3t: "வணிக தெரிவுநிலை இல்லை",
    probC3d:
    ...
    feat1d:
      "ஒவ்வொரு வாகனையும் முழு விவரங்களுடன் பதிவு செய்யுங்கள். QR ஸ்கேன் மூலம் வரலாறு கிடைக்கும்.",
    ...
    priceSub: "மாதாந்திரம் செலுத்துங்கள். ஒப்பந்தம் இல்லை. எப்போதும் ரத்து செய்யலாம்.",
    basicLabel: "BASIC",
    ...
    priceNote: "இரண்டு திட்டங்களிலும் 30 நாள் இலவச சோதனை. கிரெடிட் கார்டு தேவையில்லை.",
    ...
    ctaSub: "இப்போதே WhatsApp இல் செய்தி அனுப்புங்கள். 2 மணி நேரத்தில் கணக்கு தயார்.",
    ...
    footBuilt: "கண்டியில் கட்டப்பட்டது 🇱🇰 · சேவை நுண்ணறிவு",
  },
};
...
export const FAQ_DATA: Record<Lang, Faq[]> = {
  ...
  si: [
    ...
    },
    {
      ...
      a: "ඔව්. Manager, Technician, Cashier, Receptionist ලෙස staff ආරාධනා කළ හැකිය. එක් එක් කෙනාට ඔවුන්ට අදාළ දෑ පමණක් දිස් වේ.",
    },
    {
      q: "ගනුදෙනුකරු දුරකථන අංකය වෙනස් කළොත්?",
      a: "ගනුදෙනුකරු profile එකේ අංකය update කරන්න. ඊළඟ SMS නව අංකට යයි.",
    },
    {
  ...
  ta: [
    ...
    },
    {
      ...
      a: "இல்லை. மாதாந்திர சந்தா மட்டுமே. கணக்கு அமைப்பு மற்றும் onboarding இலவசம்.",
    },
    {
      q: "தொலைபேசியில் பயன்படுத்தலாமா?",
      a: "ஆம். PitstopIQ எந்த ஸ்மார்ட்போன் பிரவுசரிலும் இயங்கும். app தேவையில்லை.",
    },
    {
